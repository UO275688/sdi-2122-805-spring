...
import com.uniovi.sdi2122805labspring.pageobjects.*;
...
class Sdi2122805LabSpringApplicationTests {
    ...
    void PR01B() {
        ...
        Assertions.assertEquals(welcomeMessageElement.get(0).getText(), PO_HomeView.getP().getString("welcome.message",
                PO_Properties.getSPANISH()));
    }

    //PR02. Opción de navegación. Pinchar en el enlace Registro (signup) en la página home
    @Test
    @Order(3)
    public void PR02() {
    ...
    //PR03. Opción de navegación. Pinchar en el enlace Identifícate (Login) en la página home
    @Test
    @Order(4)
    public void PR03() {
    ...
    public void PR06B() {
        PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
        PO_SignUpView.fillForm(driver, "99999990B", "Jose", "Perez",
                "77777", "77777");
    ...
    public void PR08() {
        ...
        //Rellenamos el formulario
        PO_LoginView.fillLoginForm(driver, "99999993D", "123456", "ROLE_PROFESSOR");
    ...
    public void PR09() {
        ...
        //Rellenamos el formulario
        PO_LoginView.fillLoginForm(driver, "99999988F", "123456", "ROLE_ADMIN");
    ...
    public void PR10() {
        ...
        //Rellenamos el formulario
        PO_LoginView.fillLoginForm(driver, "99999990A", "123456", "ROLE_STUDENT");
    ...
    @Order(18)
    public void PR12_2() {
        //Vamos al formulario de logueo y rellenamos el formulario
        PO_PrivateView.goLoginAndFill(driver, "99999990A","123456", "Notas del usuario");
        ...
        PO_PrivateView.goLogout(driver);
    }
    ...
    public void PR13() {
        ...
        //Esperamos por la ventana de detalle checkText = "Detalles de la nota";
    ...
    public void PR13_2() {
        ...
        //Esperamos por la ventana de detalle checkText = "Detalles de la nota";
        result = PO_View.checkElementBy(driver, "text", "Notas del usuario");
        Assertions.assertEquals("Notas del usuario", result.get(0).getText());
    ...
    public void PR14_2() {
        //Vamos al formulario de login.
        PO_PrivateView.goLoginAndFill(driver, "99999993D", "123456", "Notas del usuario");
        ...
        String checkText = "Nota Nueva 1";
        PO_PrivateView.fillFormAddMark(driver, 3, checkText, "8");
        //Esperamos a que se muestren los enlaces de paginación de la lista de notas y nos vamos a la última página
        PO_PrivateView.showEnlacesAndGotToLastPage(driver, "free", "//a[contains(@class, 'page-link')]");
    ...
    public void PR15() {
        ...
        elements.get(0).click(); //Volvemos a la última página elements = PO_View.checkElementBy(driver, "free", "//a[contains(@class, 'page-link')]"); elements.get(3).click();
    ...
    public void PR15_2() {
        ...
        elements = PO_View.checkElementBy(driver, "free", "//a[contains(@href, 'mark/list')]");
        elements.get(0).click();
        //Esperamos a que se muestren los enlaces de paginación la lista de notas y nos vamos a la última página
        PO_PrivateView.showEnlacesAndGotToLastPage(driver, "free", "//a[contains(@class, 'page-link')]");
